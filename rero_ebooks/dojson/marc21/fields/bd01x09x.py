...
def language_code(self, key, value):
    ...
    return {
        ...
        "language_code_of_original_accompanying_materials_other_than_librettos": utils.force_list(  # nopep8
            value.get("m")
        ),
...
def synthesized_classification_number_components(self, key, value):
    ...
    return {
        "__order__": tuple(order) if len(order) else None,
        "number_where_instructions_are_found_single_number_or_beginning_number_of_span": utils.force_list(  # nopep8
            value.get("a")
        ),
        ...
        "number_in_internal_subarrangement_or_add_table_where_instructions_are_found": utils.force_list(  # nopep8
            value.get("v")
        ),
        "linkage": value.get("6"),
        "table_identification": utils.force_list(value.get("z")),
        ...
        "digits_added_from_classification_number_in_schedule_or_external_table": utils.force_list(  # nopep8
            value.get("s")
        ),
        "classification_number_ending_number_of_span": utils.force_list(value.get("c")),
    }
