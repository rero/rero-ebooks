...
def language_code(self, key, value):
    ...
    field_map = {
        ...
        '2': 'source_of_code',
        'm': 'language_code_of_original_accompanying_materials_other_than_librettos',  # nopep8
    ...
    return {
        ...
        'language_code_of_original_accompanying_materials_other_than_librettos':  # nopep8
...
@marc21.over(
    'classification_numbers_assigned_in_canada', '^055[01_][9721645803_]'
)
@utils.for_each_value
@utils.filter_values
...
def synthesized_classification_number_components(self, key, value):
    ...
    field_map = {
        'a': 'number_where_instructions_are_found_single_number_or_beginning_number_of_span',  # nopep8
        'r': 'root_number',
        'w': 'table_identification_internal_subarrangement_or_add_table',
        'b': 'base_number',
        'y': 'table_sequence_number_for_internal_subarrangement_or_add_table',
        'v': 'number_in_internal_subarrangement_or_add_table_where_instructions_are_found',  # nopep8
        '6': 'linkage',
        'z': 'table_identification',
        '8': 'field_link_and_sequence_number',
        'f': 'facet_designator',
        ...
        's': 'digits_added_from_classification_number_in_schedule_or_external_table',  # nopep8
        'c': 'classification_number_ending_number_of_span',
    }
    ...
    return {
        '__order__': tuple(order) if len(order) else None,
        'number_where_instructions_are_found_single_number_or_beginning_number_of_span':  # nopep8
            utils.force_list(value.get('a')),
        ...
        'table_sequence_number_for_internal_subarrangement_or_add_table':
            utils.force_list(value.get('y')),
        'number_in_internal_subarrangement_or_add_table_where_instructions_are_found':  # nopep8
        ...
        'digits_added_from_internal_subarrangement_or_add_table':
            utils.force_list(value.get('t')),
        'digits_added_from_classification_number_in_schedule_or_external_table':  # nopep8
