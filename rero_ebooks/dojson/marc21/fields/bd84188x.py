...
def holding_institution(self, key, value):
    ...
    return {
        ...
        'holding_institution': utils.force_list(value.get('a')),
    }
...
def location(self, key, value):
    ...
    return {
        ...
        'coded_location_qualifier': utils.force_list(value.get('f')),
...
def replacement_record_information(self, key, value):
    ...
    return {
        '__order__': tuple(order) if len(order) else None,
        'replacement_title': utils.force_list(value.get('a')),
        'field_link_and_sequence_number': utils.force_list(value.get('8')),
...
def non_marc_information_field(self, key, value):
    ...
    field_map = {'2': 'source_of_data', 'a': 'content_of_non_marc_field'}
