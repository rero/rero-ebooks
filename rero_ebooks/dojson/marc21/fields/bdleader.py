...
def leader(self, key, value):
    ...
    type_of_control = {'#': 'no_specified_type', 'a': 'archival'}
    ...
    length_of_the_length_of_field_portion = {'4': 4}
    length_of_the_starting_character_position_portion = {'5': 5}
    length_of_the_implementation_defined_portion = {'0': 0}
    undefined = {'0': 0}

    return {
        'record_length': int(value[:5].replace(' ', '0')),
        ...
        'indicator_count': int(value[10].replace(' ', '0')),
        'subfield_code_count': int(value[11].replace(' ', '0')),
        'base_address_of_data': int(value[12:17].replace(' ', '0')),
