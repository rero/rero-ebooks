...
def geospatial_reference_data(self, key, value):
    ...
    field_map = {
        ...
        '8': 'field_link_and_sequence_number',
        'n': 'azimuth_measure_point_longitude_or_straight_vertical_longitude_from_pole',  # nopep8
    ...
    return {
        ...
        'field_link_and_sequence_number': utils.force_list(value.get('8')),
        'azimuth_measure_point_longitude_or_straight_vertical_longitude_from_pole': value.get('n'),  # nopep8
        'local_planar_local_or_other_projection_or_grid_description': value.get('v'),  # nopep8
...
def normalized_date_and_sequential_designation(self, key, value):
    ...
    return {
        ...
        'alternative_numbering_scheme_first_level_of_enumeration': value.get(
            'g'
        ),
        ...
        'linkage': value.get('6'),
        'alternative_numbering_scheme_second_level_of_enumeration': value.get(
            'h'
        ),
