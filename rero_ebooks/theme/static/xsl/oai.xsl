...
<xsl:template name="quicklinks">
    <ul class="quicklinks">
      ...
      <li><a href="?verb=ListRecords&amp;metadataPrefix=marc21">ListRecords</a> | </li>
      <li><a href="?verb=ListSets">ListSets</a> | </li>
      <li><a href="?verb=ListMetadataFormats">ListMetadataFormats</a> | </li>
      <li><a href="?verb=ListIdentifiers&amp;metadataPrefix=marc21">ListIdentifiers</a></li>
    </ul>
</xsl:template>
...
<xsl:template match="oai:header">
  ...
  <table class="values">
    ...
    <td class="value">
      ...
      <xsl:text> </xsl:text><a class="link" href="?verb=GetRecord&amp;metadataPrefix=marc21&amp;identifier={oai:identifier}">marc21</a>
...
<xsl:template match="oai:setSpec">
  ...
  <td class="value"><xsl:value-of select="."/>
    <xsl:text> </xsl:text><a class="link" href="?verb=ListIdentifiers&amp;metadataPrefix=marc21&amp;set={.}">Identifiers</a>
    <xsl:text> </xsl:text><a class="link" href="?verb=ListRecords&amp;metadataPrefix=marc21&amp;set={.}">Records</a>
  </td></tr>
</xsl:template>
...
<xsl:template match="marc:record" xmlns:marc="http://www.loc.gov/MARC21/slim">
  <div class="dcdata">
    <h3>Marcxml (marc21)</h3>
    <table class="dcdata">
      <tr>
        <td class="tag">LDR<xsl:text>&#x20;&#x20;&#x20;</xsl:text></td>
        <td class="value"><xsl:value-of select="marc:leader"/></td>
      </tr>
      <xsl:for-each select="marc:controlfield">
        <tr>
          <td class="tag"><xsl:value-of select="@tag"/></td>
      ...
      <xsl:for-each select="marc:datafield">
        <tr>
          <td class="tag">
            ...
            <xsl:text>&#x20;</xsl:text>
            <xsl:value-of select="translate(@ind1, ' ', '_')" />
            <xsl:value-of select="translate(@ind2, ' ', '_')"/>
          </td>
          <td class="value">
