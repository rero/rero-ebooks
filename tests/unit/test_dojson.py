...
def test_json_publisher_name():
    ...
    data = {
        'publisher_name': 'Editions Gallimard'
    }
    assert cantook_json.do(data) == {
        '__order__': [
...
def test_json_cover_flipbook_link():
    ...
    data = {'cover': 'http://images.immateriel.fr/covers/FWK3BH5.png',
        ...
        'electronic_location_and_access': [
            {
                'uniform_resource_identifier':
                    'http://images.immateriel.fr/covers/FWK3BH5.png',
            ...
            {
                'uniform_resource_identifier':
                    'http://livre.immateriel.fr/FWK3BH5?no_sign_in=true',
