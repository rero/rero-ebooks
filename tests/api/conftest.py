...
def cdf_record():
    ...
    yield {
        ...
        "other_standard_identifier": [
            {
                "__order__": ["standard_number_or_code"],
                "standard_number_or_code": "http://cantookstation.com/resources/"
        ...
        "electronic_location_and_access": [
            {
                ...
                "uniform_resource_identifier": "http://images.immateriel.fr/covers/X8WRJB3.png",
            },
            {
                "access_method": "HTTP",
...
def mv_record():
    ...
    yield {
        "__order__": ["other_standard_identifier", "electronic_location_and_access"],
        "other_standard_identifier": [
            {
                "__order__": ["standard_number_or_code"],
                "standard_number_or_code": "http://cantookstation.com/resources/"
...
def cantook_mv_record():
    ...
    yield {
        ...
        "cover_large": None,
        "flipbook": "http://livre.immateriel.fr/BH9WPJ8?no_sign_in=true&no_buy_link=true",
        "languages": ["fre"],
        "page_count": 160,
        "translated_from": "",
        "contributors": [
        ...
        "classifications": [
            {
                "standard": "bisac",
                "identifiers": ["SEL000000"],
                "captions": [{"fr": None, "en": None}],
            },
            {
                "standard": "cantook",
                "identifiers": ["self-help", "health"],
                "captions": [
                    {"fr": "Croissance personnelle", "en": "Self-Help"},
                    {"fr": "Santé", "en": "Health"},
                ],
            },
            {
                ...
                "captions": [
                    ...
                    {"fr": "Documentaires", "en": "Non-Fiction"},
                    {"fr": "Santé & Vie quotidienne", "en": "Health & fitness"},
                ],
            },
        ],
        "publisher": {"name": "Jouvence"},
    }
